...
public class UpdateExpense extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(UpdateExpense.class.getName());

    /**
     * Creates new form UpdateIncome
     */
    public UpdateExpense(int user_id) {
        initComponents();
        setVisible(true);
    ...
    try {
     ...
     boolean editRows()
     {
         ...
         int selectedRow = jTable2.getSelectedRow();
          int expenseId = Integer.parseInt(jTable2.getValueAt(selectedRow, 3).toString());
        ...
        if(d_amount <= 0)
        {
           ...
           if (selectedRow != -1) 
           {
             try {
                 Connection con = DBUtility.getConnection();
                 String sql = "UPDATE expense SET date_of_expense=?, source=?, amount=? WHERE expense_id=?";
                 ...
                 System.getLogger(UpdateExpense.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
             }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Edit & update your expense ");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 10, 830, 80));
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-720, -70, 2660, 1120));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new UpdateExpense().setVisible(true));
    }
