...
public class ViewIncome extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ViewIncome.class.getName());

    /**
     * Creates new form ViewIncome
     */
    public ViewIncome(int userId) {
        initComponents();
        this.user_id = userId;
        setVisible(true);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-760, -10, 2520, 1090));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ViewIncome().setVisible(true));
    }
